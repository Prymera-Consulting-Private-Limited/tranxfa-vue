...
export function useQuoteUtils() {
     ...
     * @param {string|null} linkedPaymentAccount
     * @returns {Promise<axios.AxiosResponse<any>>}
     */
    const confirmQuote = async (quote, purpose, paymentMethod, paymentDataAttributes = null, thirdPartyDeclarationAccepted = false, linkedPaymentAccount = null) => {
        return axios.post(`/client/v1/quote/confirm/${quote.id}`, {
            ...
            customer_linked_payment_account_id: linkedPaymentAccount,
        });
    }
