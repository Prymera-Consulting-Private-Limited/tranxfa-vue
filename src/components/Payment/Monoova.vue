...
// The account details cannot be shown until the payment is PENDING; once it is,
// the socket carries the rest. Before this the component subscribed and did
// nothing else, so a broadcast that arrived during the ~2.5s before the
// subscription existed left the customer on a spinner until they refreshed.
