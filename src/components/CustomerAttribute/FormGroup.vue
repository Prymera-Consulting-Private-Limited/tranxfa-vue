...
<template>
  ...
  <MiddleNameInput v-if="attr.attribute === 'middle_name'" v-bind:attr="attr" v-on:customer:attribute:updated="notifyAttributeUpdated" />
  <LastNameInput v-if="attr.attribute === 'last_name'" v-bind:attr="attr" v-on:customer:attribute:updated="notifyAttributeUpdated" />
  <DateOfBirthInput v-if="attr.attribute === 'birth_detail.birth_date'" v-bind:attr="attr" v-on:customer:attribute:updated="notifyAttributeUpdated" />
  <NationalityInput v-if="attr.attribute === 'nationality_id'" v-bind:attr="attr" v-on:customer:attribute:updated="notifyAttributeUpdated" />
