...
<template>
  <div>
    <label :class="[errors?.mobile_number_country_id?.length > 0 ? 'text-red-700' : 'text-purple-700']" class="block text-sm font-medium mb-0">Country</label>
  ...
  <div>
    <label for="mobile-number" :class="[errors?.mobile_number?.length > 0 ? 'text-red-700' : 'text-purple-700']" class="block text-sm font-medium mb-0">Mobile Number</label>
    <p class="mt-2 mb-3 text-gray-400 text-sm"></p>
