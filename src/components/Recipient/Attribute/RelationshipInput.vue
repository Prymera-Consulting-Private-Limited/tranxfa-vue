...
<template>
  <v-select append-to-body :calculate-position="withPopper" v-on:option:selected="optionSelected" v-model="relationship" :options="relationships" :placeholder="`${placeholder}`" key-by="id" :label="$t('transfer.wizard.title')">
