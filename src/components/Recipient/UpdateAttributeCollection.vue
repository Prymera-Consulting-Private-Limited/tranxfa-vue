...
<template>
  ...
  <form v-else @submit.prevent="updateRecipient" class="space-y-6 sm:min-w-md">
    ...
    <button :class="{'opacity-60' : isSaving}" :disabled="isSaving" type="submit" class="block w-full bg-brand-700 text-white text-center py-2.5 rounded-xl font-medium hover:bg-brand-800 transition cursor-pointer text-sm/6">
