...
<template>
  <h2 class="text-base font-semibold text-gray-900">Selecciona un método de pago al beneficiario</h2>
  <p class="mt-1 text-sm/6 text-gray-500">Para que tu beneficiario en {{ country.commonName }} reciba {{ currency.isoAlpha }}</p>
