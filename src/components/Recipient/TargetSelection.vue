...
<template>
  <div>
    <h2 class="text-base font-semibold text-gray-900">Selecciona el país del beneficiario</h2>
    <p class="mt-1 text-sm/6 text-gray-500">Elige el país del beneficiario en la lista de abajo.</p>
