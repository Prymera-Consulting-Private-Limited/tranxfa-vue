...
<template>
  <div :class="{'opacity-75': transaction.state.code === TransactionState.CANCELLED}" class="flex min-w-0 gap-x-4 px-4 md:px-0">
    ...
    <div class="min-w-0 flex-auto">
      <div class="text-sm/6 font-semibold text-gray-900">{{ transaction.localAmountCurrencyPrefixed }} a <span class="text-brand-700">{{ transaction.recipient.wholeName }}</span></div>
