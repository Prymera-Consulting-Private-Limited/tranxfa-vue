...
<template>
  <Popover as="header" class="bg-brand-700 pb-24" v-slot="{ open }">
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      <div class="relative flex items-center justify-center py-10 md:py-5 lg:justify-between">
        <!-- Logo -->
        <div class="absolute left-0 shrink-0 lg:static">
          <a href="#">
            <span class="sr-only">RemitSo</span>
            <img class="h-20 w-auto" src="/images/logo-white.png" alt="RemitSo" />
          </a>
        </div>
            ...
            <div class="divide-y divide-gray-200 rounded-lg bg-white ring-1 shadow-lg ring-black/5">
              <div class="pt-3 pb-2">
                <div class="flex items-center justify-between px-4">
                  <div>
                    <img class="h-20 w-auto" src="/images/logo.png" alt="RemitSo Inc" />
                  </div>
                  <div class="-mr-2">
