...
<template>
  <div>
    ...
    <p v-if="rate.perNight.isStated" class="mt-0.5 text-xs/5 text-gray-500">{{ $t('travel.nightsNightSMiddotCurrencyprefixed', {nights: nights, s: nights === 1 ? '' : 's', currencyPrefixed: rate.perNight.currencyPrefixed}) }}</p>
