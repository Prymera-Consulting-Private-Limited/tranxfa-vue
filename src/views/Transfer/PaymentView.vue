              ...
              <div class="py-0 sm:pb-6 px-6">
                <div class="mt-3 text-center sm:mt-5">
                  ...
                  <div v-else-if="loadFailed" class="text-center">
                    ...
                    <button @click="loadTransaction" class="mt-2 px-4 md:px-6 lg:px-8 bg-blue-600 text-white text-center py-3 rounded-md font-medium hover:bg-blue-700 transition cursor-pointer text-sm/6 outline-none ring-0 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-700">Try again</button>
                  </div>
                </div>
              </div>
            </DialogPanel>
