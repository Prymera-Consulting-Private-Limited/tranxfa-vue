    ...
    <div class="relative flex items-center justify-center min-h-screen bg-gray-50 tracking-wider">
      ...
      <div v-else class="relative flex flex-col md:flex-row w-full h-screen bg-white">
        <div class=" w-[60%] md:w-[60%] h-auto md:h-full">
          <!-- Brand artwork. reset.png is quiqsend's own; resetpassword.png is
               the inherited default and byte-identical to main's. -->
          <img src="/images/backgrounds/reset.png" :alt="$t('auth.signIn.backgroundAlt')" class="w-full h-90 md:h-full object-cover hidden md:block">
