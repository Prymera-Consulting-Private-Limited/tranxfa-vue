...
const MIGRATED = [
  ...
  // Xenvia only: the contact screen does not exist on main. The discovery arm
  // below found it on the first brand merge after SD-1132 - it had been
  // carrying its copy in the markup, which is the one thing a brand branch is
  // not supposed to do.
